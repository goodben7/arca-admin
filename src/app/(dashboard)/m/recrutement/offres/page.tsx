...
export default function JobOffersPage() {
    ...
    return (
        <PageShell>
            ...
            <PageKpiStrip
                items={[
                    { label: 'Offres totales', value: stats.total, icon: Briefcase, tone: 'primary', detail: 'En cours de traitement' },
                ...
                {isLoading ? (
                    ...
                    <div className="relative">
                                            ...
                                            <TableRow key={o.id} className="group">
                                                ...
                                                <TableCell className="px-6 text-right">
                                                    <div className="flex items-center justify-end gap-1">
                                                        ...
                                                        <Link href={`/m/recrutement/offres/${o.id}`}>
                        ...
                        <div className="p-6 border-t border-primary-100/40 table-footer-wash flex items-center justify-between gap-4">
                            ...
                            <Link href="/m/recrutement/demandes">
