            ...
            <PageHeader
                ...
                actions={
                    <>
                        ...
                        <Link href="/m/personnel/contracts/create">
                    ...
                    <div className="relative">
                        ...
                        {isTypeDropdownOpen && (
                            <>
                                ...
                                <div className="absolute top-full left-0 mt-2 w-52 bg-white rounded-2xl shadow-2xl shadow-secondary-900/10 border border-secondary-100 p-2 z-50 animate-in fade-in zoom-in-95 duration-200">
                                    {typeOptions.map((opt) => (
                                        <button
                                            key={opt.id || 'all'}
                                        ...
                                        return (
                                            <TableRow key={con.id} className="group">
                                                ...
                                                <TableCell className="px-6 text-right">
                                                    <Link href={`/m/personnel/contracts/${con.id}`}>
