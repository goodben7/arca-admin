...
export default function TrainingSessionDetailPage() {
    ...
    const handleEnroll = async (employeeId: string) => {
        ...
        try {
            ...
            toast.success('Participant enrollé avec succès.');
    ...
    const handleStartEnrollment = async (enrollmentId: string) => {
        ...
        try {
            ...
            toast.success('Participation démarrée.');
            if (session) await reloadEnrollments(session.id);
        } catch (e: unknown) { setEnrollmentError((e as Error)?.message || 'Erreur.'); }
        finally { setEnrollmentActionId(null); }
    };
    ...
    const handleCompleteEnrollment = async (enrollmentId: string) => {
        ...
        try {
            ...
            toast.success('Participation marquée comme terminée.');
    ...
    const handleCertifyEnrollment = async (enrollmentId: string, score: number, certificate: string) => {
        ...
        try {
            ...
            toast.success('Formation certifiée.');
    ...
    return (
        <>
            ...
            <ConfirmModal
                ...
                title="Marquer comme terminé" description="Confirmez-vous que ce participant a bien terminé la formation ?"
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            <div className="flex items-center gap-3 mt-0.5 flex-wrap">
                                                                ...
                                                                <p className="text-xs text-secondary-300 font-medium">
                                                                    Inscrit le {safeFormatDate(enrollment.enrolledAt || enrollment.createdAt)}
                                                                </p>
