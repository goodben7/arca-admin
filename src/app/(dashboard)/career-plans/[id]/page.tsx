                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-secondary-500">
                                                        Niveau requis : {SKILL_LEVEL_LABELS[rs.requiredLevel as SkillLevel] || rs.requiredLevel}
                ...
                <div className="space-y-4">
                    ...
                    {careerPath && (
                        <Card className="p-6">
                            ...
                            <Link href="/career-paths" className="text-xs text-primary-500 hover:underline mt-3 inline-block">
