...
export default function MobilityDetailPage() {
    ...
    if (error || !request) {
        return (
            <div className="p-10 flex flex-col items-center justify-center gap-4 text-center">
                ...
                <Button variant="outline" onClick={() => router.push('/mobility')}>Retour</Button>
            </div>
        );
    }
    ...
    return (
        <PageShell>
            {toast && (
                <div className={`fixed top-6 right-6 z-[70] flex items-center gap-3 px-5 py-4 rounded-2xl shadow-2xl text-sm font-bold animate-in slide-in-from-right duration-300 ${
