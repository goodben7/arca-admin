...
export default function MobilityPage() {
    ...
    const statusOptions = [
        ...
        { id: MOBILITY_STATUS.MANAGER_APPROVAL, label: 'Manager', color: 'bg-amber-500' },
    ...
    return (
        <PageShell>
            ...
            <PageKpiStrip
                items={[
                    { label: 'Total demandes', value: stats.total, icon: ArrowRightLeft, tone: 'primary', detail: 'Dans le pipeline' },
